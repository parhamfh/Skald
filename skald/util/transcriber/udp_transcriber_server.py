...
class UDPTranscriberServer(TranscriberServer):
    ...
    def __init__(self, server_sock=None, port=7777, remote_is_local=False):
        super(UDPTranscriberServer, self).__init__()
    ...
    def process_requests(self):
        while self.IS_TRANSCODING:
            ...
            print '{0} | Printing repr of pickled data. You can use this to check that the correct data has been received.'.format(self)
